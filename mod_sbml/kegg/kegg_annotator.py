...
from mod_sbml.annotation.annotation_manager import infer_reaction_kegg_from_compounds_kegg
...
from mod_sbml.sbml.sbml_manager import get_kegg_m_id, add_annotation
