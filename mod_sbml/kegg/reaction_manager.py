...
from mod_sbml.kegg.pathway_manager import p_id_specific2generic
from mod_sbml.utils import misc
from mod_sbml.serialization.xlsx_helper import HEADER_STYLE, add_values, get_info

KEGG_REACTION_FILE = os.path.join(os.path.dirname(os.path.abspath(misc.__file__)), '..', 'data', 'KEGG_reactions.xlsx')
KEGG_COMPOUND_FILE = os.path.join(os.path.dirname(os.path.abspath(misc.__file__)), '..', 'data', 'KEGG_compounds.xlsx')
