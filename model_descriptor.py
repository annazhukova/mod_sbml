...
from sbml_manager import get_metabolites, get_pathway2r_ids, get_subsystem2r_ids, get_reactants, get_products
...
def model_statistics(model, org, groups=True, pathways=True, extracellular=None):
    ...
    blocked_ms = {s_id for s_id in s_id2r_rs if s_id not in s_id2p_rs} | \
                 {s_id for s_id in s_id2p_rs if s_id not in s_id2r_rs}
    ...
    if groups:
        ...
        group2m_ids, m_id2group, m_group2info = group_metabolites(model, m_id2chebi)
